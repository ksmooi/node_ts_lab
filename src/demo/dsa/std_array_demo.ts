...
function demoArrayInitializationAndAccess() {
...
function demoArrayManipulation() {
    const fruits: string[] = ["Apple", "Banana", "Cherry"];
...
// === Advanced Methods ===
function demoAdvancedArrayMethods() {
    const fruits: string[] = ["Blueberry", "Apple", "Mango"];
    ...
    console.log("Fruits in uppercase:", upperCaseFruits);  // Expected: BLUEBERRY, APPLE, MANGO
    ...
    console.log(concatenatedFruits);  // Expected: Fruits: Blueberry Apple Mango
...
// === Run all demos ===
function runStdArrayDemos() {
    console.log("=== Array Initialization and Access Demo ===");
    demoArrayInitializationAndAccess();

    console.log("\n=== Array Iteration Demo ===");
    demoArrayIteration();

    console.log("\n=== Array Manipulation Demo ===");
    demoArrayManipulation();

    console.log("\n=== Advanced Array Methods Demo ===");
    demoAdvancedArrayMethods();
}
