...
function demoTypedArrayInitializationAndAccess() {
...
function demoTypedArrayIteration() {
    const typedArray: Int16Array = new Int16Array([10, 20, 30, 40, 50]);
...
function demoTypedArrayManipulation() {
    const typedArray: Int16Array = new Int16Array([10, 20, 30, 40, 50]);
...
// === Advanced Methods ===
function demoTypedArrayAdvancedMethods() {
    const typedArray: Int16Array = new Int16Array([10, 25, 30, 40, 50]);
...
// === Run all demos ===
function runStdTypedArrayDemos() {
    console.log("=== TypedArray Initialization and Access ===");
    demoTypedArrayInitializationAndAccess();

    console.log("\n=== TypedArray Iteration ===");
    demoTypedArrayIteration();

    console.log("\n=== TypedArray Manipulation ===");
    demoTypedArrayManipulation();

    console.log("\n=== Advanced TypedArray Methods ===");
    demoTypedArrayAdvancedMethods();
}

// Execute all demos
runStdTypedArrayDemos();
